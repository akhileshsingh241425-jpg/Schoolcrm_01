...
import {
  Event, Refresh, Search, CalendarMonth, Info, School,
...
const EVENT_ICONS = {
  holiday: <CalendarMonth />, exam: <Assignment />, ptm: <School />,
          ...
          <Box sx={{ display: 'flex', alignItems: 'stretch' }}>
            ...
            <Box sx={{ p: 2.5, flex: 1 }}>
              ...
              <Box sx={{
                ...
                <School sx={{ fontSize: 14, color: isPast ? '#9e9e9e' : color, flexShrink: 0 }} />
