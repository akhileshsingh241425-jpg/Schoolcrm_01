...
export const createBubbleTheme = (colorPreset) => {
  ...
  return createTheme({
    ...
    typography: {
      ...
      h1: { fontWeight: 700, letterSpacing: '-0.02em', '@media (max-width:600px)': { fontSize: '1.75rem' } },
      h2: { fontWeight: 700, letterSpacing: '-0.01em', '@media (max-width:600px)': { fontSize: '1.5rem' } },
      h3: { fontWeight: 700, '@media (max-width:600px)': { fontSize: '1.35rem' } },
      h4: { fontWeight: 700, '@media (max-width:600px)': { fontSize: '1.15rem' } },
      h5: { fontWeight: 600, '@media (max-width:600px)': { fontSize: '1.05rem' } },
