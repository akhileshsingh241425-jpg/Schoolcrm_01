...
const menuGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Data Import', icon: <CloudUpload />, path: '/data-import', module: 'data_import', role: ['school_admin', 'super_admin'] },
      { text: 'School Branding', icon: <Brush />, path: '/school-branding', module: 'settings', role: ['school_admin', 'super_admin'] },
